  ...
  /*-------------------------
    ...
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $this.html(event.strftime('<span class="cdown day">%-D <p>Dias</p></span> <span class="cdown hour">%-H <p>Horas</p></span> <span class="cdown minutes">%M <p>Minutos</p></span> <span class="cdown second">%S <p>Segundos</p></span>'));
        });
    });
