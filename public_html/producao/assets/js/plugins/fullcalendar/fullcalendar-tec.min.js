...
! function(a) {
    ...
    var wb = Wa.TimeGrid = tb.extend(ub, {
        ...
        renderSlatRowHtml: function() {
            for (var a, c, d, e = this.view, f = this.isRTL, g = "", h = b.duration(+this.minTime); h < this.maxTime;) a = this.start.clone().time(h), c = ha(R(h, this.labelInterval)), d = '<td class="fc-axis fc-time ' + e.widgetContentClass + '" ' + e.axisStyleAttr() + ">" + "<span>" + ((ca(a.format(this.labelFormat)).length < 6) ? ca(a.format(this.labelFormat)).replace(' hs', '') + ':00' : ca(a.format(this.labelFormat)).replace(' hs', '')) + "</span>" + "</td>", g += '<tr data-time="' + a.format("HH:mm:ss") + '"' + (c ? "" : ' class="fc-minor"') + ">" + (f ? "" : d) + '<td class="' + e.widgetContentClass + '"/>' + (f ? d : "") + "</tr>", h.add(this.slotDuration);
            return g
        },
