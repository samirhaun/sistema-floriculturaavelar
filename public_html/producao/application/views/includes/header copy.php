...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/style.css"/>
      ...
      <!-- PLUGIN WHATSAPP -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/js/plugin-zap/floating-wpp.css">
            ...
            <div class="header-middle-inner">
                <div class="header-logo-menu">
                    ...
                    <div class="header-logo">
                        <a href="<?php echo base_url() ?>"><img alt="Gury Informática" src="<?php echo base_url() ?>assets/images/logo.png"
                                                                 class="logo"></a></div>
                </div>
                    ...
                    <div class="header-search">
                        <div class="block-search">
                            <form role="search" method="get"
                                  ...
                                  action="<?php echo base_url() ?>produtos">
                                <div class="form-content search-box results-search">
                                    <div class="inner">
                                        <input autocomplete="off" class="searchfield txt-livesearch input" name="pesquisa"
                                               value="" placeholder="Pesquise um produto..." type="text">
                                    </div>
                                </div>
                                <input value="product" type="hidden">
                                <input value="product_cat" type="hidden">
                               <!--  <div class="category">
                                ...
                                <ul id="menu-vertical-menu" class="azeroth-nav vertical-menu default">
                                    ...
                                    <li id="menu-item-886"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-886"><a
                                            class="azeroth-menu-item-title" title="<?php echo $categoria->nome ?>" href="<?php echo base_url() ?>produtos?categorias=<?php echo $categoria->nome_tag ?>"><?php echo $categoria->nome ?></a></li>
    ...
    <div class="header-mobile">
        <div class="header-mobile-left">
            ...
            <div class="header-search azeroth-dropdown">
                ...
                <div class="block-search" style="top: 8%">
                    <form role="search" method="get" 
                    action="<?php echo base_url() ?>produtos"
                          class="form-search block-search-form azeroth-live-search-form">
                        <div class="form-content search-box results-search">
                            <div class="inner">
                                <input autocomplete="off" style="min-width: 263px;" class="searchfield txt-livesearch input" name="pesquisa" value=""
                                       placeholder="Pesquise um produto..." type="text">
                            </div>
                        </div>
