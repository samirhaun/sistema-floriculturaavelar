...
function salvar_pedido(){
  ...
  if($this->input->post()){
    ...
    $excedeu_pct = ($tipo_desconto == 'porcentagem') && $desconto_maximo > 0 && $pct_aplicado > $desconto_maximo;
    $excedeu_valor = ($tipo_desconto != 'porcentagem') && $desconto_maximo_valor > 0 && $desconto_em_reais > $desconto_maximo_valor;
