            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url(array('site', 'novo-tipo-denuncia')) ?>">
                            <!-- <i class="fa fa-plus"></i> -->
                            Novo tipo de Denuncia
                        </a>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-view" >
                            ...
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $tipo->id ?>">
                                            <td><?php echo $tipo->id; ?></td>
                                            <td><?php echo $tipo->nome_tipo_denuncia; ?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(array('site', 'editar-tipo-denuncia')) ?>?id=<?php echo $tipo->id ?>" class="btn btn-default btn-icon-action" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil-square-o"></i></a>
