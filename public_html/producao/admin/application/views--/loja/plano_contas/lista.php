                                        ...
                                        <tr class="gradeC" id="item-<?php echo $valor->id ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- <a href="#" class="btn btn-default btn-icon-action" data-toggle="tooltip" title="Visualizar"><i class="fa fa-file-text-o"></i></a> -->
                                                    <a href="<?php echo base_url(array('loja', 'editar-plano_contas')) ?>?id=<?php echo $valor->id ?>" class="btn btn-default btn-icon-action" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil-square-o"></i></a>

                                                  <a href="<?php echo base_url(array('loja', 'excluir-plano_contas')) ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $valor->id ?>" data-toggle="tooltip" data-placement="bottom" title="Excluir"><i class="fa fa-trash"></i></a>
