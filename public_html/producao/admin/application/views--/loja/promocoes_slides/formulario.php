<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo (isset($promocao_slides)) ? 'Editar cadastro da cupom' : 'Novo cadastro de cupom' ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Loja</a>
            </li>
            <li>
                <a href="<?php echo base_url(array('loja', 'promocoes-slides')) ?>">cupons</a>
            </li>
            <li class="active">
                <strong><?php echo (isset($promocao_slides)) ? 'Editar cadastro da cupom' : 'Novo cadastro de cupom' ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('loja', 'salvar-promocao')) ?>" method="post" id="form-cadastro-promocao" enctype="multipart/form-data">
                        <?php if (isset($promocao_slides)): ?>
                            <input type="hidden" name="id" value="<?php echo $promocao_slides->id ?>">
                        <?php endif ?>
                        <div class="hr-line-dashed"></div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label">Código Cupom: *</label>
                                    <input type="text" name="titulo" class="form-control" value="<?php echo (isset($promocao_slides)) ? $promocao_slides->titulo : '' ?>" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label">Descricão: *</label>
                                    <input type="text" name="descricao" class="form-control" value="<?php echo (isset($promocao_slides)) ? $promocao_slides->descricao : '' ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="porcentagem_desconto" class="form-control porcentagem_desconto" value="<?php echo (isset($promocao_slides)) ? $promocao_slides->porcentagem_desconto : '' ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="valido_ate" class="form-control datepicker" value="<?php echo (isset($promocao_slides)) ? inverteData($promocao_slides->valido_ate,'/') : '' ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="text-right">
                                        <a href="<?php echo base_url(array('loja', 'categorias')) ?>" class="btn btn-white">Cancelar</a>
...
<div class="modal fade" id="myModal" role="dialog">
    <div style="    width: 86%;" class="modal-dialog modal-lg">
...
$(function() {
  ...
  $('.porcentagem_desconto').mask('00', {reverse: true});

const $form = $('#form-cadastro-promocao');

$()
.add($form.find('[name$="valido_ate"]'))
.datepicker({
autoclose: false,
calendarWeeks: false,
clearBtn: false,
...
var teste;
    ...
    $("#form-cadastro-promocao").validate({});
