...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo (isset($produto)) ? 'Editar saída/baixa de produto' : 'Nova saída/baixa de produto' ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Loja</a>
            </li>
            <li>
                <a href="<?php echo base_url(array('loja', 'produtos-saida')) ?>">produtos</a>
            </li>
            <li class="active">
                <strong><?php echo (isset($produto)) ? 'Editar saida de produto' : 'Nova saida de produto' ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
...
<div class="wrapper wrapper-content animated">
    <div class="row">
                <form action="<?php echo base_url(array('loja', 'salvar-produto-saida')) ?>" method="post" id="form-cadastro-produto" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <div class="tabs-container">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="active"><a class="nav-link active" data-toggle="tab" href="#tab-1" > Dados da saida</a></li>
                                    <li><a class="nav-link" data-toggle="tab" href="#tab-2">Produtos saída/baixa</a></li>
                                </ul>
                                                ...
                                                <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="text-right">
                                                            <a href="<?php echo base_url(array('loja', 'produtos-saida')) ?>" class="btn btn-white">Cancelar</a>
