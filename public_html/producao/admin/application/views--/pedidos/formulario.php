  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <input type="hidden" id="contador_qtd_produtos" value="<?php echo (isset($pedido)) ? sizeof($produtos_pedidos) : 1 ?>">
        ...
        <div class="row">
          <div class=" col-md-12">
            ...
            <div class="horarios">
              ...
              <?php if (isset($produtos_pedidos)){ $total_existentes = sizeof($produtos_pedidos); $contador_existentes = 1; ?>
          ...
          <div class="col-sm-3 col-xs-10">
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select required="" class="form-control" name="forma_pagamento">
