                ...
                <form action="<?php echo base_url(array('loja', 'salvar-produto')) ?>" method="post" id="form-cadastro-produto" enctype="multipart/form-data">
                   ...
                   <!--          <div class="col-sm-2 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-xs-12">
                            <div class="form-group">
                                    <label class="control-label">Exibir em pedidos: </label>
                                    <select class="form-control" name="exibir_em_pedidos">
                                        <option <?php if(isset($produto) && $produto->exibir_em_pedidos == 1) echo 'selected="selected"'; ?> value="1">SIM</option>
                                        <option <?php if(isset($produto) && $produto->exibir_em_pedidos == 0) echo 'selected="selected"'; ?> value="0">NÃO</option>    
                                    </select>
                                </div> 
                                </div>
