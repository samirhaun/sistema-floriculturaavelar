 ...
 <div class="row">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <h1 style="margin-left: 45% ">Certificação</h1>
          
                    <form action="<?php echo base_url(array('site', 'editar-certificacao')) ?>" method="post" id="form-cadastro-institucional" enctype="multipart/form-data">
                        <?php if ($certificacao): ?>
                            <input type="hidden" name="id" value="<?php echo $certificacao->id ?>">
                        <?php endif ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descricao" class="summernote"><?php echo ($certificacao) ? $certificacao->descricao : '' ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 preview-image">
                                <div class="lightBoxGallery">
                                    <?php if ($certificacao): ?>
                                        <img id="img-show" src="<?php echo base_url('') ?>../assets/images/paginas/<?php echo $certificacao->imagem ?>">
                                    <?php endif ?>
                        ...
                        <?php if ($certificacao): ?>
                            <input type="hidden" name="imagem_institucional" value="<?php echo $certificacao->imagem ?>">
                        <?php endif ?>
                        <div class="hr-line-dashed"></div>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
