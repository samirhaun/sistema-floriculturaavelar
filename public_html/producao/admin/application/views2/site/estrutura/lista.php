                            ...
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $estrutura->id ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(array('site', 'editar-estrutura')) ?>?id=<?php echo $estrutura->id ?>" class="btn btn-default btn-icon-action" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil-square-o"></i></a>
                                                <a href="<?php echo base_url(array('site', 'excluir-estrutura')) ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $estrutura->id ?>" data-toggle="tooltip" data-placement="bottom" title="Excluir"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                            <?php
                                    }
