...
\                                </address>-->
                        ...
                        <div class="row">
                            ...
                            <span><strong>Forma de pagamento:</strong> 
                                    ...
                                    <?php foreach($pedido->receitas as $receita): ?>
                                       ...
                                       <strong>Vencimento:</strong> <?php echo inverteData($receita->data_vencimento, '/')  ?> 
                                     - <strong>Valor:</strong>  <?php echo number_format($receita->valor, 2, ',', '.'); ?>
                        ...
                        <table class="table invoice-total">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo ($pedido->tipo_desconto == 'porcentagem') ? '%' : 'R$'; ?>
                                 
                                    
                                <?php echo number_format($pedido->valor_desconto, 2, ',', '.'); ?></td>
                            </tr>
                            <tr>
