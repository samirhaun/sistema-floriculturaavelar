 ...
 <div class="row item"> 
          ...
          <div class="col-sm-2 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="data_vencimento_receita[]" class="form-control data_mask" value="<?php echo (isset($pedido)) ? inverteData($conta_receber->data_vencimento,'/')  : date('d/m/Y') ?>" required>
                </div>
            </div>
