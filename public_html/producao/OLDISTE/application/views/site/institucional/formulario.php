    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <h1>O Projeto Meritus</h1>
          
                    <form action="<?php echo base_url(array('site', 'editar-institucional')) ?>" method="post" id="form-cadastro-institucional" enctype="multipart/form-data">
                        <?php if ($projeto): ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descricao" class="summernote"><?php echo ($projeto) ? $projeto->descricao : '' ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 preview-image">
                                <div class="lightBoxGallery">
                                    <?php if ($projeto): ?>
                                        <img id="img-show" src="<?php echo base_url('') ?>../assets/images/paginas/<?php echo $projeto->imagem ?>">
                                    <?php endif ?>
                        ...
                        <?php if ($projeto): ?>
                            <input type="hidden" name="imagem_institucional" value="<?php echo $projeto->imagem ?>">
                        <?php endif ?>
                        <div class="hr-line-dashed"></div>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
