                                    ...
                                    <ul class="wc_payment_methods payment_methods methods">
                                        <li class="wc_payment_method payment_method_bacs">
                                            ...
                                            <label for="payment_method_bacs">
                                                ...
                                                <p style="padding-top: 10px;">
                                                    <select title="product_cat" name="forma_pagamento" class="orderby" onclick="verifica_pgto_dinheiro(this.value)">
                                                ...
                                                <p class="form-row form-row-wide address-field validate-required precisa_troco"
                                               id="billing_city_field" data-priority="70"
                                               style="display: none"
                                               data-o_class="form-row form-row-wide address-field validate-required">
                                               <label for="cep" class="">Precisa de troco?&nbsp;</label><input type="text"
                                                                                             class="input-text "
                                                                                             name="troco"
                                                                                             id="troco"
                                                                                             placeholder="quero troco para R$" value=""
                                                                                             autocomplete="address-level2"></span>
                                            </p>
                                        ...
                                        <li class="wc_payment_method payment_method_cheque">
                                            ...
                                            <label for="payment_method_cheque">
                                                Retirar na loja (frete será isento) </label>
...
<script type="text/javascript">
      ...
      function verifica_pgto_dinheiro(valor){
          if(valor == 1){
            $('.precisa_troco').show();
          }else{
            $('.precisa_troco').hide();
