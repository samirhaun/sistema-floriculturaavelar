                ...
                <div class="shop-control shop-after-control">
                    <nav class="woocommerce-pagination">
                        ...
                        <?php 
                         ...
                         <a class="page-numbers" href="<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.'&marcas='.$marcas_selecionadas.'&preco='.$preco_selecionado.'&desconto='.$desconto_selecionado.'&pesquisa='.$pesquisa_selecionada.'&filtro_classificacao='.$filtro_classificacao_selecionada.'&paginacao='.$qtd_prod_pagina.'_'.$ofset ?>"
                ...
                <div id="widget-area" class="widget-area shop-sidebar">
                    <div id="woocommerce_product_search-2" class="widget woocommerce widget_product_search">
                        ...
                        action="">
                            ...
                            <input id="woocommerce-product-search-field-0" class="search-field"
                                   placeholder="Buscar produto…" value="<?php echo $pesquisa_selecionada ?>" name="pesquisa" type="search">
                            <button type="button" onclick="submit_pesquisa()" value="Search">Search</button>
                    ...
                    <div id="woocommerce_layered_nav-6"
                        ...
                        <ul class="woocommerce-widget-layered-nav-list">
                            ...
                            <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo $class_selecionada ?>">
                                <a rel="nofollow" 
                                href="<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.$categoria->nome_tag.';'.'&marcas='.$marcas_selecionadas.'&preco='.$preco_selecionado.'&desconto='.$desconto_selecionado.'&pesquisa='.$pesquisa_selecionada.'&filtro_classificacao='.$filtro_classificacao_selecionada ?>">
                    ...
                    <div id="woocommerce_layered_nav-6"
                        ...
                        <ul class="woocommerce-widget-layered-nav-list">
                            ...
                            <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo $class_selecionada ?>">
                                <a rel="nofollow" 
                                href="<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.'&marcas='.$marcas_selecionadas.$marca->nome_tag.';'.'&preco='.$preco_selecionado.'&desconto='.$desconto_selecionado.'&pesquisa='.$pesquisa_selecionada.'&filtro_classificacao='.$filtro_classificacao_selecionada ?>">
                    ...
                    <div id="woocommerce_layered_nav-6"
                        ...
                        <ul class="woocommerce-widget-layered-nav-list">
                            ...
                            <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo $class_selecionada ?>">
                                <a rel="nofollow" 
                                   href="<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.'&marcas='.$marcas_selecionadas.'&preco='.$preco_selecionado.$preco['valor'].';'.'&desconto='.$desconto_selecionado.'&pesquisa='.$pesquisa_selecionada.'&filtro_classificacao='.$filtro_classificacao_selecionada ?>"><?php echo $preco['descricao'] ?></a>
                                </li>
                    ...
                    <div id="woocommerce_layered_nav-6"
                        ...
                        <ul class="woocommerce-widget-layered-nav-list">
                            ...
                            <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo $class_selecionada ?>">
                                <a rel="nofollow" 
                                   href="<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.'&marcas='.$marcas_selecionadas.'&preco='.$preco_selecionado.'&desconto='.$desconto_selecionado.$desconto['valor'].';'.'&pesquisa='.$pesquisa_selecionada.'&filtro_classificacao='.$filtro_classificacao_selecionada ?>"><?php echo $desconto['descricao'] ?></a>
                                </li>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function filtrar_classificacao(){
            ...
            var url = "<?php echo base_url() ?>produtos?categorias=<?php echo $categorias_selecionadas.'&marcas='.$marcas_selecionadas.'&preco='.$preco_selecionado.'&desconto='.$desconto_selecionado.'&pesquisa='.$pesquisa_selecionada ?>"+'&filtro_classificacao='+filtro;
