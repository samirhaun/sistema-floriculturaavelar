...
class Site extends TEC_Controller {
   ...
   public function index(){
    $dados  = array(
        ...
        'produtos_nao_ofertas' => $this->loja_model->get_nao_ofertas_produtos(),
    ...
    // echo '<pre>';
    // print_r($dados['produtos_ofertas']);
    // exit;
...
public function produtos(){
  ...
  if(!empty($_GET['filtro_classificacao'])){
    ...
    $dados['filtro_classificacao_selecionada'] = 'mais_recente';
  }
