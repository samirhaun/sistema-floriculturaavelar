                ...
                <div class="col-sm-2">
                  <div class="form-group text-left">
                    ...
                    <!-- <select class="form-control search-select-old" id="situacao_pgto" name="situacao_pgto" required> -->
                      <option <?php echo (isset($filtro_situacao_pgto) && $filtro_situacao_pgto == "all" ||  !isset($filtro_situacao_pgto)) ? 'selected' : '' ?> data-tipo="" value="all">Todas</option>
                      <option <?php echo (isset($filtro_situacao_pgto) && $filtro_situacao_pgto == "1") ? 'selected' : '' ?> data-tipo="" value="1">Pago</option>
                      <option <?php echo (isset($filtro_situacao_pgto) && $filtro_situacao_pgto == "2") ? 'selected' : '' ?> data-tipo="" value="2">Pago parciamente</option>
