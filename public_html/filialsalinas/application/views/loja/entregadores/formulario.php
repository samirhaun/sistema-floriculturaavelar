<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(array('loja', 'entregadores')) ?>">entregadores</a>
            </li>
            <li class="active">
                <strong><?php echo (isset($dados)) ? 'Editar cadastro de entregador' : 'Novo cadastro de entregador' ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('loja', 'salvar-entregador')) ?>" method="post" id="form-cadastro-categoria" enctype="multipart/form-data">
                        <?php if (isset($dados)): ?>
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="text-right">
                                        <a href="<?php echo base_url(array('loja', 'entregadores')) ?>" class="btn btn-white">Cancelar</a>
