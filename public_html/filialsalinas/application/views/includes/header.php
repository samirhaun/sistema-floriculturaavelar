        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li>
                        <a href="#"><i class="fa fa-exchange"></i> <span class="nav-label">Filial: Salinas</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <?php if(in_array('producao', $contextos_usuario)): ?>
                                <li><a href="/producao/admin/">Montes Claros</a></li>
                            <?php endif; ?>
                            <?php if(in_array('salinas', $contextos_usuario)): ?>
                                <li class="active"><a href="/filialsalinas/">Salinas</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
...
<!-- 
                    ...
                    <li id="home">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <?php endif; ?>
                            <?php if(check_habilidade('visualizar_entregadores')): ?>
                            <li id="Loja-entregadores"><a href="<?php echo base_url(array('loja', 'entregadores')) ?>">Entregadores</a></li>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if(check_habilidade('visualizar_fretes')): ?>
                            <li id="lista-transparencia"><a href="<?php echo base_url(array('site/transparencia')) ?>">Fretes Bairro</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    ...
                    <li id="site">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <?php if(check_habilidade('relatorios_fluxo_caixa_pedidos')): ?>
                            <li id="loja-demonstrativo"><a href="<?php echo base_url(array('loja', 'demonstrativo')) ?>">Pedidos</a></li>
                            <?php endif; ?>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <i class="fa fa-exchange"></i> Filial: Salinas <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <?php if(in_array('producao', $contextos_usuario)): ?>
                                    <li><a href="/producao/admin/" target="_blank"><i class="fa fa-external-link"></i> Abrir Montes Claros</a></li>
                                <?php endif; ?>
                                <?php if(in_array('salinas', $contextos_usuario)): ?>
                                    <li><a href="/filialsalinas/"><i class="fa fa-check"></i> Salinas</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <!-- <li class="dropdown">
