<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(array('site', 'marcas')) ?>">Marcas</a>
            </li>
            <li class="active">
                Editar Marca
            </li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('loja', 'update-marcas')) ?>" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titulo" class="form-control" value="<?php echo $marca->titulo ?>" required="" >
                                </div>
                            </div>
                        </div>
                      <!--   <div class="hr-line-dashed"></div>
