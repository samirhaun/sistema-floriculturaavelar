...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo (isset($transparencia)) ? 'Editar cadastro do frete' : 'Novo cadastro de frete' ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Site</a>
            </li>
            <li>
                <a href="<?php echo base_url(array('site', 'transparencia')) ?>">Frete bairro</a>
            </li>
            <li class="active">
                <strong><?php echo (isset($transparencia)) ? 'Editar cadastro de frete' : 'Novo cadastro de frete' ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                ...
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('site', 'salvar-transparencia')) ?>" method="post" id="form-cadastro-estrutura" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label">Termo bairro:*</label>
